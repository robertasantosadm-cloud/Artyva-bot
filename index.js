...
async function processMessage(from, text) {
  ...
  if (s.phase === 'aguarda_menu') {
    if (msg === '1' || msg.includes('diagnos')) {
      ...
      // Pausa em AMBOS os casos — dentro e fora do horario
      pausados[from] = true;
      s.phase = 'menu';
      ...
      if (dentroDoHorario()) {
        ...
        await send(from,
          ...
          '\ud83d\udcde *(11) 2368-4091*\n' +
          '\ud83d\udce7 artyva@artyva.com.br\n\n' +
          'Se quiser, enquanto isso posso te ajudar:\n' +
          '1\ufe0f\u20e3 Fazer o diagn\u00f3stico gratuito\n' +
          '3\ufe0f\u20e3 Agendar uma visita'
        );
        // Fora do horario: despausa para cliente poder continuar com diagnostico
        pausados[from] = false;
        s.phase = 'aguarda_menu';
      }
